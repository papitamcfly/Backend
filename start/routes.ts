...
Route.post('/createAdress','AdreesController.store').middleware('auth:api')
Route.get('/viewAdress','AdreesController.index').middleware(['auth:api','role:admin'])
Route.get('/viewpAdress','AdreesController.indexp').middleware('auth:api')
